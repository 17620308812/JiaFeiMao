...
live2d_settings['modelAPI'] = 'http://localhost:8084/live2d-server'
...
live2d_settings['homePageUrl'] = 'http://localhost:8085/#/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
...
function initModel(waifuPath, type) {
    ...
    } catch (err) { console.log('[Error] JQuery UI is not defined.', err) }
