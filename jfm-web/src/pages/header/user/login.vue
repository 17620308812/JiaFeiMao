<template>
  <div
    style="padding-bottom: 20px; min-height: 600px; height: calc(100vh - 295px)"
  >
    <div
      style="
        margin-top: 50px;
        height: 86px;
        background-color: rgb(80 169 219);
        text-align: center;
      "
    >
    ...
    <div style="width: 980px; margin: 40px auto">
      ...
      <div
        style="height: 350px; position: relative; margin-top: 60px"
        class="login-panel"
      >
        <div style="width: 50%; float: left; text-align: center">
          ...
          <div class="erweima-bottom" style="position: relative">
            ...
            />
            <img
              src="~@/pages/header/user/resource/1.png"
        ...
        <div style="width: 50%; float: left">
          <div style="padding: 30px 45px 0px 45px">
            ...
            >
              ...
              <div
                style="line-height: 20px; margin-bottom: 5px; margin-top: 40px"
              >
                ...
                <span style="float: right; font-size: 12px">
                  <span
                    style="color: #02a7de; cursor: pointer; margin-right: 5px"
                    >无法验证？</span
                  >
                  <span style="color: #02a7de; cursor: pointer"
                    >忘记密码？</span
                  >
                </span>
              </div>
