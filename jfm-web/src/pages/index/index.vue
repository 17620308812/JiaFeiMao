<template>
  <div>
    <div class="index-header">
      <div class="index-header-bgc"></div>
    </div>

    <div class="index-two-header" style="width:85%;margin:0 auto;min-width:1400px;max-width:1600px">
      <!-- 一级标题 -->
      <div style="display:flex;padding-top:15px">
        <div style="display:flex;">
          <div style="min-width:55px;text-align:center;cursor:pointer">
            <div
              style="width:36px;height:36px;border-radius: 36px;background-color:#ff5c7c;margin:0 auto;color: white;font-size: 25px;line-height:36px;"
            >
              <i class="el-icon-house"></i>
            </div>
            <div class="two-title-hover">首页</div>
          </div>
          <div style="min-width:55px;text-align:center;cursor:pointer">
            <div
              style="width:36px;height:36px;border-radius: 36px;background-color:#fcba2a;margin:0 auto;color: white;font-size: 25px;line-height:36px;"
            >
              <i class="el-icon-cpu"></i>
            </div>
            <div class="two-title-hover">动态</div>
          </div>
          <div style="min-width:55px;text-align:center;cursor:pointer">
            <div
              style="width:36px;height:36px;border-radius: 36px;background-color:#00a1d6;margin:0 auto;color: white;font-size: 25px;line-height:36px;"
            >
              <i class="el-icon-c-scale-to-original"></i>
            </div>
            <div class="two-title-hover">排行榜</div>
          </div>
          <div style="min-width:55px;text-align:center;cursor:pointer">
            <div
              style="width:36px;height:36px;border-radius: 36px;background-color:#6dc781;margin:0 auto;color: white;font-size: 25px;line-height:36px;"
            >
              <i class="el-icon-coin"></i>
            </div>
            <div class="two-title-hover">频道</div>
          </div>
        </div>
        ...
        <el-divider direction="vertical"></el-divider>
        <div style="display:flex;margin-left:10px;min-width:270px">
          <div style="min-width:80px">
            <div style="display:flex;cursor:pointer;height:30px;line-height:30px">
              <div style="padding-top:4px;margin-right:4px">
                <JfmIconZhuanlan size="25" />
              </div>
              <div class="two-title-hover" style="height:30px;line-height:30px">专栏</div>
            </div>
            <div style="display:flex;cursor:pointer;height:30px;line-height:30px">
          ...
          <div style="min-width:80px">
            <div style="display:flex;cursor:pointer;height:30px;line-height:30px">
              ...
              <div class="two-title-hover" style="height:30px;line-height:30px">活动</div>
            </div>
            <div style="display:flex;cursor:pointer;height:30px;line-height:30px">
              <div style="padding-top:4px;margin-right:4px">
      ...
      <div style="margin-top:15px;margin-bottom:20px">
        <el-row :gutter="15">
            ...
            <div class="index-scroll-select">
              <ul>
                <li @click="handleIndexSelect('1')">
                  <div :class="currentSelect==='1'?'index-selected':'no-index-selected'"></div>
                </li>
                <li @click="handleIndexSelect('2')">
                  <div :class="currentSelect==='2'?'index-selected':'no-index-selected'"></div>
                </li>
                <li @click="handleIndexSelect('3')">
                  <div :class="currentSelect==='3'?'index-selected':'no-index-selected'"></div>
                </li>
                <li @click="handleIndexSelect('4')">
                  <div :class="currentSelect==='4'?'index-selected':'no-index-selected'"></div>
                </li>
                <li @click="handleIndexSelect('5')">
                  <div :class="currentSelect==='5'?'index-selected':'no-index-selected'"></div>
                </li>
              </ul>
            </div>
          </el-col>
          <el-col :span="4">
            <div class="grid-content bg-purple">
              <div
                style="position:relative;overflow:hidden;border-radius:5px;margin-bottom:15px"
                class="index-mouse-mover"
              >
                <div style="width:100%;height:117px">
                  <img src="~@/resource/index-show/index-show-1.jpg" style="width:100%;height:100%" />
                </div>
                <div class="mover-text">
                  <p>【电影史话06】他为韩国电影创造了历史——奉俊昊作品全解读</p>
                  <div style="color:antiquewhite;margin-top: 10px;font-size:13px;">
                    <span style="border: 2px solid;border-radius: 5px;margin-right:10px">作者</span>
                    <span>咸鱼的鱼</span>
                  </div>
                  <div style="color:antiquewhite;font-size:13px;margin-top:5px">42.0万播放</div>
                </div>
              </div>
              <div
                style="position:relative;overflow:hidden;border-radius:5px"
                class="index-mouse-mover"
              >
                <div style="width:100%;height:117px">
                  <img src="~@/resource/index-show/index-show-2.jpg" style="width:100%;height:100%" />
                </div>
                <div class="mover-text">
                  <p>入门经典,深入浅出html,虎课网html5基础培训,快速上手</p>
                  <div style="color:antiquewhite;margin-top: 10px;font-size:13px;">
                    <span style="border: 2px solid;border-radius: 5px;margin-right:10px">作者</span>
                    <span>灵风</span>
                  </div>
          ...
          <el-col :span="4">
            <div class="grid-content bg-purple">
              ...
              >
                <div style="width:100%;height:117px">
                  <img src="~@/resource/index-show/index-show-3.png" style="width:100%;height:100%" />
                </div>
                <div class="mover-text">
                  ...
                  <div style="color:antiquewhite;font-size:13px;margin-top:5px">763.0万播放</div>
                </div>
              </div>
              <div
                style="position:relative;overflow:hidden;border-radius:5px"
              ...
              >
                <div style="width:100%;height:117px">
                  <img src="~@/resource/index-show/index-show-4.jpg" style="width:100%;height:100%" />
                </div>
                <div class="mover-text">
                  ...
                  <div style="color:antiquewhite;font-size:13px;margin-top:5px">586.0万播放</div>
                </div>
              </div>
            </div>
          </el-col>
          <el-col :span="4">
            <div class="grid-content bg-purple">
              ...
              >
                <div style="width:100%;height:117px">
                  <img src="~@/resource/index-show/index-show-5.jpg" style="width:100%;height:100%" />
                </div>
                <div class="mover-text">
              ...
              >
                <div style="width:100%;height:117px">
                  <img src="~@/resource/index-show/index-show-6.jpg" style="width:100%;height:100%" />
                </div>
                <div class="mover-text">
          ...
          <el-col :span="4">
            <div class="grid-content bg-purple">
              ...
              >
                <div style="width:100%;height:117px">
                  <img src="~@/resource/index-show/index-show-7.png" style="width:100%;height:100%" />
                </div>
                <div class="mover-text">
                  ...
                  <div style="color:antiquewhite;font-size:13px;margin-top:5px">657.0万播放</div>
                </div>
              </div>
              <div
                style="position:relative;overflow:hidden;border-radius:5px"
              ...
              >
                <div style="width:100%;height:117px">
                  <img src="~@/resource/index-show/index-show-8.jpg" style="width:100%;height:100%" />
                </div>
                <div class="mover-text">
                  ...
                  <div style="color:antiquewhite;font-size:13px;margin-top:5px">123.0万播放</div>
                </div>
              </div>
            </div>
          </el-col>
...
.index-two-header /deep/ .el-divider--vertical {
  height: 45px;
  margin-top: 5px;
}

.index-two-header /deep/ .el-tag--mini {
